...
$msgsend_name="Silent (admin)";	//This Name will be show if you send a message to a Server

$show_motd=true;				// Set it to false to not show the message of the day window

$show_version=false;				// Set it to false to not show the Webinterface Version on the footer
?>